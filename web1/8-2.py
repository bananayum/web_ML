...
def load_adfa_java_files(rootdir):
    ...
    for file in allfile:
        if re.match(r"/Users/banana/Desktop/1book-master/data/ADFA-LD/Attack_Data_Master/Java_Meterpreter_\d+/UAD-Java-Meterpreter*",file):
...
if __name__ == '__main__':
    ...
    x2,y2=load_adfa_java_files("/Users/banana/Desktop/1book-master/data/ADFA-LD/Attack_Data_Master/")
