...
if __name__ == '__main__':
    user_cmd_list,dist=load_user_cmd_new("/Users/banana/Desktop/1book-master/data/MasqueradeDat/User3")
    user_cmd_feature=get_user_cmd_feature_new(user_cmd_list,dist)
    labels=get_label("/Users/banana/Desktop/1book-master/data/MasqueradeDat/label.txt",2)
    y=[0]*50+labels
