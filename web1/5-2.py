...
if __name__ == '__main__':
    user_cmd_list,user_cmd_dist_max,user_cmd_dist_min=load_user_cmd("/Users/banana/Desktop/1book-master/data/MasqueradeDat/User4")
    user_cmd_feature=get_user_cmd_feature(user_cmd_list,user_cmd_dist_max,user_cmd_dist_min)
    labels=get_label("/Users/banana/Desktop/1book-master/data/MasqueradeDat/label.txt",3)
    y=[0]*50+labels
